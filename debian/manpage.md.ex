% qmi-net-systemd(SECTION) | User Commands
%
% "September 30 2024"
...
qmi-net-systemd - program to do something

# SYNOPSIS

**qmi-net-systemd** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**qmi-net-systemd** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **qmi-net-systemd** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**qmi-net-systemd** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    qmi-net-systemd. See **foo.conf**(5) for further details.
...
**qmi-net-systemd** provides some return codes, that can be used in scripts:
